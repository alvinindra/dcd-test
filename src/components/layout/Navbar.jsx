      ...
      >
        <div className='relative container flex flex-wrap items-center mx-auto justify-center md:justify-start py-2 md:py-0'>
          <Link href='/' passHref>
            <a className='flex items-center'>
              <Image
                ...
                alt='Dicoding Logo'
              />
              <span className='ml-2 text-2xl font-medium whitespace-nowrap text-white'>
                Jobs
              </span>
            </a>
          </Link>
          ...
          <div className='hidden items-center w-full md:flex md:w-auto'>
            ...
            <ul className='flex flex-col p-4 mt-4 rounded-lg border md:flex-row md:space-x-8 md:mt-0 md:text-base md:font-medium md:border-0 text-white'>
              <li>
            ...
            <ul className='flex flex-col items-center p-4 mt-4 rounded-lg border md:flex-row md:space-x-8 md:mt-0 md:text-base md:font-medium md:border-0 text-white'>
              <li>
                <div className='relative w-full'>
                  ...
                  <select
                    id='select-interview'
                    className='bg-transparent border border-secondary-300 text-white text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full pl-12 py-3 px-4'
                  >
